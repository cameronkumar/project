...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Apr 12 11:10:26 2016
# Project:  project.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile project.pro
#############################################################################
...
Makefile: project.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project1.0.0/ && $(COPY_FILE) --parents vis.h .tmp/project1.0.0/ && $(COPY_FILE) --parents main.cpp vis.cpp .tmp/project1.0.0/ && (cd `dirname .tmp/project1.0.0` && $(TAR) project1.0.0.tar project1.0.0 && $(COMPRESS) project1.0.0.tar) && $(MOVE) `dirname .tmp/project1.0.0`/project1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project1.0.0
...
compiler_moc_header_make_all: moc_vis.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_vis.cpp
moc_vis.cpp: vis.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) vis.h -o moc_vis.cpp
...
main.o: main.cpp vis.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

vis.o: vis.cpp vis.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o vis.o vis.cpp

moc_vis.o: moc_vis.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_vis.o moc_vis.cpp
